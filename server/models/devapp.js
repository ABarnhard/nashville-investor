...
function massageData(data){
  ...
  activeApps.forEach(function(app){
    ...
    var row = {project:app.project_name, meetingDate: new Date(app.mpc_meeting_date)},
        marker = {lat:parseFloat(app.mapped_location.latitude), lng:parseFloat(app.mapped_location.longitude), name: row.project, icon: '/assets/images/markers/new-com.png'};
