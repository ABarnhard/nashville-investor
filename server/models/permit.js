...
function getIconOrColor(type, permit){
  if(permit === 'CADM'){
    ...
    switch(type){
      case 'I':
        return '/assets/images/markers/demolition.png';
      default:
        return '#FF4136';
    }
    ...
    switch(type){
      case 'I':
        return '/assets/images/markers/new-res.png';
      default:
        return '#01FF70';
    }
    ...
    switch(type){
      case 'I':
        return '/assets/images/markers/ren-res.png';
      default:
        return '#39CCCC';
    }
  }else if(permit === 'CACN'){
    ...
    switch(type){
      case 'I':
        return '/assets/images/markers/new-com.png';
      default:
        return '#FFDC00';
    }
    ...
    switch(type){
      case 'I':
        return '/assets/images/markers/ren-com.png';
      default:
        return '#FF851B';
    }
  }else{
    ...
    switch(type){
      case 'I':
        return '/assets/images/markers/misc.png';
      default:
        return '#DDDDDD';
    }
  }
